...
SELECT ORDER.SALES_DATE, ORDER.SHIPPING_DATE, ORDER.SHIPPING_COST, ORDER.QUANTITY
FROM CUSTOMER as CUSTOMER_1
LEFT JOIN PURCHASE_ORDER as ORDER
ON CUSTOMER_1.CUSTOMER_ID=ORDER.CUSTOMER_ID
WHERE CUSTOMER_1.CITY like miasto
